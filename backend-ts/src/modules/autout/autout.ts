...
export class AutoUtService{
 readonly mrConfiguration:MrConfiguration;private readonly mrWorkflow:MrWorkflow;private closing=false;private monitoring=false;
